  ...
  return (
    <>
      ...
      >
        ...
        {!result && step === 3 ? <div><Intro title="用一句话说明这次做了什么">这句话会帮助同事以后找到本次记录。</Intro><label className="plain-field"><span className="field-label-row">这次做了什么<FieldHelp label="更新标题"><strong>不需要使用专业格式。</strong><ol><li>先写动作，例如“新增”“修改”或“删除”。</li><li>再写零件或资料名称。</li><li>需要时补充阶段，例如 T2。</li><li>正确示例：“修改 T2 场旋框盖图纸”。</li><li>不要只写“更新”“改了一下”或日期。</li></ol></FieldHelp></span><input aria-label="本次更新标题" autoFocus onChange={(e) => setTitle(e.target.value)} placeholder="例如：修改 T2 场旋框盖图纸" value={title} /></label></div> : null}
